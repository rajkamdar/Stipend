...
public class EditCompanyProfile2 extends AppCompatActivity
...
//        setSupportActionBar(toolbar);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    studentClient.post(EditCompanyProfile2.this, "http://192.168.23.1:12345/webservice.asmx/editcompanyprofile", studentEntity, "application/json", new JsonHttpResponseHandler() {
                        @Override
                        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                            ...
                            try {
                                ...
                                if (b == 1) {
                                    Intent studentIntent = new Intent(EditCompanyProfile2.this, CompanyHome2.class);
                        ...
                        public void onStart() {
                            super.onStart();
                            mProgressDialog = ProgressDialog.show(EditCompanyProfile2.this, "Loading", "Please Wait");
                        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            ...
            Intent mIntent=new Intent(EditCompanyProfile2.this,CompanyHome2.class);
            startActivity(mIntent);
        } else if (id == R.id.nav_gallery) {

        } else if (id == R.id.nav_slideshow) {
            Intent mIntent=new Intent(EditCompanyProfile2.this,About.class);
            startActivity(mIntent);

        } else if (id == R.id.nav_manage) {
            SharedPreferences mSharedPreferences=getSharedPreferences("system",Context.MODE_PRIVATE);
            mSharedPreferences.edit().clear().commit();
            Intent back=new Intent(EditCompanyProfile2.this,Login.class);
            startActivity(back);
            finish();
        }
